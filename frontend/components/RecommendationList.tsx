...
function isSpecItem(spec: SpecItem | false | "" | undefined): spec is SpecItem {
  ...
  return (
    ...
    <div className="space-y-4">
      ...
      {recommendations.map((item, index) => {
        ...
        const specItems: (SpecItem | false | "" | undefined)[] = [
          ...
          item.spesifikasi.bluetooth_version && {
          ...
          item.spesifikasi.codec && {

            label: "Codec",

            value: item.spesifikasi.codec,

            icon: <Disc3 className="h-3.5 w-3.5 text-fuchsia-500" strokeWidth={1.5} />,

          },

          item.spesifikasi.driver_size && {

            label: "Driver",

            value: item.spesifikasi.driver_size,

            icon: <Headphones className="h-3.5 w-3.5 text-slate-500" strokeWidth={1.5} />,

          },

          item.spesifikasi.mic_count != null && {

            label: "Mic",

            value: `${item.spesifikasi.mic_count}`,

            icon: <Mic className="h-3.5 w-3.5 text-emerald-500" strokeWidth={1.5} />,

          },

          item.spesifikasi.charging_port && {

            label: "Port",

            value: item.spesifikasi.charging_port,

            icon: <Plug className="h-3.5 w-3.5 text-amber-500" strokeWidth={1.5} />,
        ...
        return (
          ...
          >
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
              ...
              <div className="flex gap-4">
                ...
                <div className="min-w-0">
                  ...
                  {item.spesifikasi.is_hires && (

                    <span className="mt-2 inline-flex items-center gap-1 rounded-full bg-violet-50 px-2.5 py-0.5 text-[11px] font-semibold text-violet-700 ring-1 ring-violet-200">
            ...
            <div className="mt-5 grid gap-2 grid-cols-2 sm:grid-cols-3 lg:grid-cols-5">
              ...
              {specItems.filter(isSpecItem).map((spec) => (
